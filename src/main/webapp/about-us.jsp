		...
		<div class="container">
			<div class="our_bakery_text">
				...
				<p style="text-align: left;">
					...
					Nõn Café – Tập đoàn cà phê số 1 Việt Nam.<br> <br>Với
					...
					phê sách… Không gian <strong>Nõn Café</strong> đã tạo
					dựng nét văn hóa đặc biệt và duy nhất trong việc thưởng thức cà
					phê, trở thành điểm đến lý tưởng dành cho giới tri thức.<br>
					<br> Gắn liền với giá trị văn hóa, <strong>Nõn Café</strong> với Làng cà phê Buôn Ma Thuột là nơi duy nhất
		...
		<div class="container">
			<div class="video_inner">
				...
				<p>Video này mang đến cái nhìn chân thực và sâu sắc về văn hóa
					cà phê Việt Nam thông qua hành trình khám phá Nõn Café –
		...
		<div class="container">
			<div class="our_mission_inner">
				<div class="single_m_title" style="text-align: center;">
					<h2>Lịch sử phát triển Tập Đoàn Nõn Café</h2>
				</div>
			</div>
			<div class="col-lg-9">
				<div class="mission_inner_text"
					style="margin-left: 153px; width: 842px;font-size=21;">
					...
					<strong>2022</strong>: <br>- Ra mắt Thế giới Cà phê Nõn Café tại Việt Nam và Trung Quốc. <br>- Công bố Hành
					trình Trải nghiệm Lối sống Tỉnh thức. <br>- Tạp chí Forbes
					vinh danh Nõn Café là “Thương hiệu Tỉnh thức”. <br>-
