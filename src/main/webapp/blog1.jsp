...
<title>${blog.title}-NÕNCAFÉ</title>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav justify-content-end">
						...
						<li><a href="${pageContext.request.contextPath}/contact.jsp">Liên
								hệ</a></li>
					</ul>
				</div>
			</nav>
				...
				<div class="blog_details_area">
					...
					<div class="blog-meta">
						<div class="blog-meta-item">
							<i class="fa fa-user"></i> <span>Bài viết được đăng bởi: <strong>${blog.authorName}</strong></span>
						</div>
						<div class="blog-meta-item">
							<i class="fa fa-calendar"></i> <span> <fmt:formatDate
									value="${blog.publishedAt}" pattern="HH:mm 'ngày' dd/MM/yyyy" /></span>
						</div>
						<c:choose>
							...
							<c:when test="${blog.category == 'recipe'}">
								<div class="blog-meta-item">
								<i class="fa fa-folder"></i> <span>Danh mục: Công thức</span>
								</div>
							</c:when>
						</c:choose>
					</div>
