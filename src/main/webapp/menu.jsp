						...
						<div class="discover_item_inner">
							<c:forEach var="p" items="${listP}">
								...
								<div class="discover_item">
									<h4>${p.name}</h4>
									<p>
										${p.detailDescription} <span>${p.price}</span>
									</p>
								</div>
							</c:forEach>
							...
							<div class="discover_item">
								...
								<p>
									Chocolate puding, vanilla, fruite rasberry jam evporate milk <span>$12.99</span>
								</p>
							</div>
							<div class="discover_item">
								<h4>Blueberry Muffin</h4>
								<p>
									Chocolate puding, vanilla, fruite rasberry jam milk <span>$8.99</span>
								</p>
							</div>
							<div class="discover_item">
								<h4>Box of Delight</h4>
								<p>
									Chocolate puding, vanilla, fruite rasberry jam evporate milk <span>$7.99</span>
								</p>
							</div>
							<div class="discover_item">
								<h4>Classic French Croissant</h4>
								<p>
									Chocolate puding, vanilla, fruite rasberry jam evporate milk <span>$6.79</span>
								</p>
							</div>
							<div class="discover_item">
								<h4>Macarons & Tea</h4>
								<p>
									Chocolate puding, vanilla, fruite rasberry jam evporate milk <span>$5.99</span>
								</p>
							</div>
							<div class="discover_item">
							...
							<div class="discover_item">
								...
								<p>
									Chocolate puding, vanilla, fruite rasberry jam evporate milk <span>$20.00</span>
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="discover_item_inner">
							...
							<div class="discover_item">
								...
								<p>
									Chocolate puding, vanilla, fruite rasberry jam milk <span>$7.99</span>
								</p>
							</div>
							<div class="discover_item">
								<h4>Strawberry Sweet Cake</h4>
