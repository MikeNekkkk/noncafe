	...
	<section class="our_cakes_area p_100">
		<div class="container">
			<div class="main_title">
				<h2>NÕN CAFÉ</h2>
				<h5>Đến với NÕN Café, bạn được thưởng thức
					những ly cà phê năng lượng tuyệt hảo bên những cuốn sách nền tảng
					đổi đời được chọn lọc từ tinh hoa tri thức nhân loại. Cùng với năng
					lượng thực dưỡng từ ổ bánh mì ngon nhất thế gian đem đến nguồn năng
					lượng hài hòa, giúp thanh lọc và cân bằng cơ thể.</h5>
			</div>
			<div class="cake_feature_row row">

				<c:forEach var="p" items="${listP}">
					<div class="col-lg-3 col-md-4 col-sm-6 mb-4" data-id="${p.id}">
						<div class="cake_feature_item card h-100 shadow-sm border-0">

							<!-- Hình ảnh sản phẩm -->
							<div class="cake_img position-relative">
								<a href="detail?pid=${p.id}"> <img
									src="${pageContext.request.contextPath}/${p.imageUrl}"
									alt="${p.name}" class="img-fluid w-100 product-img">
								</a>
							</div>

							<!-- Thông tin sản phẩm -->
							<div class="cake_text text-center p-3">
								<h4 style="font-size: 18px;">${String.format("%,.0f", p.price)}₫</h4>
