										...
										<td>
											<form action="updateCart" method="post"
												...
												<input type="number" name="quantity"
													value="${item.quantity}" min="1" max="${p.stockQuantity}"
													style="width: 60px; text-align: center; margin-right: 5px;"
													onchange="this.form.submit()">
											</form>
										</td>
										<td>${p.stockQuantity}</td>
										<td><fmt:formatNumber value="${itemTotal}"
												pattern="#,##0" />₫</td>
										<td><a href="removeCartItem?id=${p.id}"
			...
			<div class="row cart_total_inner">
				...
				<div class="col-lg-5">
					<div class="cart_total_text">
						<div class="cart_head">Tổng số tiền hàng</div>

						<div class="total">
							<h4>
								Tổng <span><fmt:formatNumber value="${totalAmount}"
										pattern="#,##0" />₫</span>
							</h4>
						</div>
