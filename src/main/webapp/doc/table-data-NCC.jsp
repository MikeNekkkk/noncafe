...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<aside class="app-sidebar">
		...
		<ul class="app-menu">
			...
			<li><a class="app-menu__item haha" href="HTNCC"><i
					class='app-menu__icon bx bx-user-voice'></i><span
						...
						<div class="row element-button">
							<div class="col-sm-2">
								<a class="btn btn-add btn-sm" href="javascript:void(0)"
									...
									class="fas fa-plus"></i> Thêm mới Nhà cung cấp
								</a>
							</div>
						...
						<table class="table table-hover table-bordered js-copytextarea"
							...
							<thead>
								<tr>
									...
									<th width="150">Họ và tên quản kho</th>
									<th>SĐT</th>
							...
							<tbody>
								<c:forEach var="customer" items="${listNCC}">
									<tr>

										<td>${customer.id}</td>
										<td>${customer.nameKho}</td>
										<td>${customer.nameQuanKho}</td>
										...
										<td class="table-td-center">
											...
											<button class="btn btn-primary btn-sm edit" type="button"
												...
												data-id="${customer.id}" data-namekho="${customer.nameKho}"
												data-namequankho="${customer.nameQuanKho}"
				...
				<div class="modal-body">
					<div class="row">
						<div class="form-group col-md-12">
							<span class="thong-tin-thanh-toan"><h5>Thêm mới NCC</h5></span>
						</div>
					</div>
					<form id="addUserForm">
						<div class="row">
							<div class="form-group col-md-6">
								<label class="control-label">Tên Kho <span
									style="color: red">*</span></label> <input class="form-control"
									type="text" name="username" required>
							</div>

							<div class="form-group col-md-12">
								<label class="control-label">Họ và tên Quản kho <span
									style="color: red">*</span></label> <input class="form-control"
					...
					<div class="row">
						<div class="form-group col-md-12">
							<span class="thong-tin-thanh-toan"><h5>Chỉnh sửa
									thông tin Nhà cung cấp</h5></span>
						</div>
					</div>
    ...
    function editUser(btn) {
        ...
        $('#editUsername').val($(btn).data('namekho'));
        $('#editFullName').val($(btn).data('namequankho'));
        $('#editPhone').val($(btn).data('phone'));
        $('#editAddress').val($(btn).data('address'));
        $('#orderStatus').val($(btn).data('status'));
      ...
      swal({
        ...
        if (willDelete) {
          $.ajax({
            ...
            error: function() {
              swal("Lỗi!", "Không thể xóa nhà cung cấp!", "error");
            }
          });
        }
      });
